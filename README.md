...
This repository contains the official implementation of the paper **"Similarity Pruning: Optimizing 1NN-DTW and Distance-Based Time Series Classification"**.
...
git clone [https://github.com/luoyuqi-lab/similarity_pruning.git](https://github.com/Anonymous-submission-777/similarity-pruning.git)
